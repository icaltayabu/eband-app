                            ...
                            <div class="row">
                                <div class="col-lg-12"
                                    ...
                                    <div style="display: flex; gap: 20px; margin-bottom: 10px; width: 100%;">
                                        <p style="margin: 0; color:black">02.00</p>
                                        <p style="margin: 0; color:black">1 Jam</p>
                                        <p style="margin: 0; color:black; margin-left: auto; margin-right: 20px">04:00
                                        </p>
                        ...
                        <div class="container mt-3">
                            <div class="row">
                                <div class="col-lg-12"
                                    style="display: flex; flex-direction: column; align-items: flex-start; text-align: left; margin-bottom: 0px">
                                    <div style="display: flex; gap: 20px; margin-bottom: 10px; width: 100%;">
                                        <p style="margin: 0; color:black">06.00</p>
                                        <p style="margin: 0; color:black">1 Jam</p>
                                        <p style="margin: 0; color:black; margin-left: auto; margin-right: 20px">08:00
                                        </p>
                                        <p style="margin: 0; color:black; margin-left: auto; margin-right: 20px">
                                            <b>GATE</b>
                                        </p>
