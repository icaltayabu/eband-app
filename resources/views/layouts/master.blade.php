...
<!-- Mirrored from www.enableds.com/products/azures/v35/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Aug 2024 07:50:37 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link rel="manifest" href="{{ asset('assets/manifest.json') }}" data-pwa-version="set_in_manifest_and_pwa_js">
...
<body class="theme-light" data-highlight="blue2">
    ...
    <div id="page">
        ...
        <div id="footer-bar" class="footer-bar-5">
            <a href=""><i data-feather="heart" data-feather-line="1" data-feather-size="21"
                    data-feather-color="red-dark" data-feather-bg="red-fade-light"></i><span>Features</span></a>
            <a href=""><i data-feather="image" data-feather-line="1" data-feather-size="21"
                    data-feather-color="green-dark" data-feather-bg="green-fade-light"></i><span>Media</span></a>
            <a href="" class="active-nav"><i data-feather="home" data-feather-line="1" data-feather-size="21"
                    data-feather-color="blue-dark" data-feather-bg="blue-fade-light"></i><span>Home</span></a>
            <a href=""><i data-feather="file" data-feather-line="1" data-feather-size="21"
                    data-feather-color="brown-dark" data-feather-bg="brown-fade-light"></i><span>Pages</span></a>
            <a href=""><i data-feather="settings" data-feather-line="1" data-feather-size="21"
                    data-feather-color="dark-dark" data-feather-bg="gray-fade-light"></i><span>Settings</span></a>
        </div>
        <div class="page-content">
                            ...
                            <div class="card rounded-l mx-2 text-center shadow-l bg-17" data-card-height="320">
                                <div class="card-bottom">
                                    ...
                                    <p class="boxed-text-xl">
                                        Azures brings beauty and colors to your Mobile device with a stunning user
                                        interface to match.
                                    </p>
                                </div>
                        ...
                        <div class="splide__slide">
                            <div class="card rounded-l mx-2 text-center shadow-l bg-8" data-card-height="320">
                                <div class="card-bottom">
                                    ...
                                    <p class="boxed-text-xl">
                                        Azures is a Mobile Web App Kit, fully featured, supporting PWA and Native Dark
                                        Mode!
                                    </p>
                                </div>
                                <div class="card-overlay bg-gradient-fade"></div>
            ...
            <div class="content mt-0">
                <div class="row">
                    <div class="col-6">
                        <a href="#"
                            class="btn btn-full btn-m rounded-s text-uppercase font-900 shadow-xl bg-highlight">Purchase</a>
                    </div>
                    <div class="col-6">
                        <a href="#"
                    ...
                    <div class="splide__list">
                        <div class="splide__slide ps-3">
                            <div class="bg-theme rounded-m shadow-m text-center">
                                <i class="mt-4 mb-4" data-feather="shield" data-feather-line="1"
                                    data-feather-size="45" data-feather-color="blue-dark"
                        ...
                        <div class="splide__slide ps-3">
                            <div class="bg-theme rounded-m shadow-m text-center">
                                <i class="mt-4 mb-4" data-feather="smile" data-feather-line="1"
                                    data-feather-size="45" data-feather-color="green-dark"
            ...
            <div class="card card-style">
                ...
                <div class="content">
                    ...
                    <div class="d-flex mb-2">
                        <div>
                            <i
                                class="far fa-check-circle color-green-light fa-3x pt-3 icon-80 text-center ms-n2 me-2"></i>
                        </div>
                        <div>
                        ...
                        <div class="splide__list">
                            <div class="splide__slide">
                                <div class="text-center">
                                    <img src="images/avatars/1s.png" width="55" height="55"
                            ...
                            <div class="splide__slide">
                                <div class="text-center">
                                    <img src="images/avatars/2s.png" width="55" height="55"
            ...
            <div class="card card-style text-center">
                <div class="content pb-2">
                    ...
                    <a href="#"
                        class="btn btn-center-xl btn-m text-uppercase font-900 bg-highlight rounded-sm shadow-l">Buy
                        now - $25</a>
                </div>
            </div>
